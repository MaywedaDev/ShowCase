...
const Hero = () => {
    return ( <div className="w-full max-h-[calc(100vh-80px)] h-[780px] flex flex-col">
        <div className="w-full flex h-[calc(100%-80px)] relative">
            <div className="h-full bg-gradient-to-r from-black from-95% to-[#3B3B3B] to-95% w-[25%] max-w-[400px]">
            </div>
            <div className="absolute bottom-20 left-28 text-white max-w-[600px]">
                <h1 className="text-[96px] leading-[116px] font-medium text-header uppercase">Mercedes <br/> AMG</h1>
            ...
            <div className="w-full max-h-full overflow-hidden">
                <Image src={benzAmg} style={{ width: "100%" }} alt="benz" />
            </div>
        </div>
        <Brands />
    </div> );
